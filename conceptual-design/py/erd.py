...
'''
CREATE TABLE `A`(`a1` INT, `a2` INT, PRIMARY KEY(`a1`));
CREATE TABLE `B`(`b2` INT, `b1` INT, PRIMARY KEY(`b1`));
CREATE TABLE `R1`(`b1` INT, `x` INT, `a1` INT, PRIMARY KEY(`b1`, `a1`), FOREIGN KEY(`a1`) REFERENCES `A`(`a1`), FOREIGN KEY(`b1`) REFERENCES `B`(`b1`));
'''
...
Database([
    ...
    Table('R1', set(['a1','b1', 'x']), set(['a1','b1']), set([(('a1',), 'A', ('a1',)), (('b1',), 'B', ('b1',))]) )
    ])
'''